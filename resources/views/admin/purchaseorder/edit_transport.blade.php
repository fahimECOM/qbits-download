            ...
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-12">
                        <!--begin::Form-->
                        <form action="{{ route('purchaseorder.update',$purchaseorders->id)}}" method="POST"
                            id="kt_invoice_form">
                            @csrf
                            @method('PUT')
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-column align-items-start flex-xxl-row">
                                ...
                                <div class="d-flex align-items-center flex-equal fw-row me-4 order-2"
                                    ...
                                    <div class="fs-6 fw-bolder text-gray-700 text-nowrap">
                                        <img alt="Logo"
                                            src="{{ asset('backend/assets/media/logos/logo-1-dark.svg') }}"><br><br>
                                        <span>Address:</span>
                                    </div>
                                    <!--end::Date-->
                                    <!--begin::Input-->
                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-10 mb-5">
                                    <!--begin::Col-->
                                    <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Transport
                                            Information</label>
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <!--begin::Input group-->
                                            <div class="input-group d-flex flex-column mb-7 fv-row" id="vendor_name">
                                                ...
                                                <select name="transport_id" id="transport_id"
                                                    ...
                                                    data-placeholder="Select an option" data-hide-search="false"
                                                    data-dropdown-parent="#vendor_name">
                                                    <option></option>
                                                    @foreach ($transportvendors as $vendor_transport)
                                                    <option value="{{ $vendor_transport->id }}" @if($purchaseorders->
                                                        agent_id == $vendor_transport->id) selected
                                                        @endif>{{ $vendor_transport->name }}</option>
                                                    @endforeach
                                                </select>
                                                <!--end::Input-->
                                    ...
                                    <table class="table g-5 gs-0 mb-0 fw-bolder text-gray-700" data-kt-element="items">
                                        ...
                                        <tbody>
                                            <tr class="border-bottom border-bottom-dashed" data-kt-element="item"
                                                id="transport_detail">
                                                <td class="pe-7">
                                                    <select name="transport_detail_name[]" id="transport_detail_id"
                                                        class="form-select form-select-solid mb-2 product_type_selection"
                                                        data-control="select2" data-placeholder="Select an option"
                                                        data-hide-search="true"
                                                        data-dropdown-parent="#transport_detail">


                                                        <option value="{{ $purchaseorders->product_name }}">
                                                            {{ $purchaseorders->product_name }}</option>
                                                        {{-- <option></option>
                                                        @foreach($transport_details as $transport_detail)
                                                            <option value="{{ $transport_detail->id }}">{{ $transport_detail->amount }}
                                                        </option>
                                                        @endforeach --}}
                                                    </select>
                                    ...
                                    <tr class="border-bottom border-bottom-dashed" data-kt-element="item"
                                        ...
                                        <td class="pe-7">
                                            <select name="name[]" class="form-select form-select-solid mb-2"
                                                data-placeholder="Select an option" data-hide-search="false" disabled>
                                                <option></option>
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                name="description[]" placeholder="Description" disabled />
                                        </td>

                                        <td>
                                            <select name="unit[]" class="form-select form-select-solid"
                                                data-placeholder="Select an option" data-hide-search="true" disabled>
                                                <option></option>
                                        ...
                                        <td class="ps-0">
                                            <input class="form-control form-control-solid" type="number" min="1"
                                                name="quantity[]" placeholder="1" data-kt-element="quantity" disabled />
                                        </td>
                                        <td>
                                            <input type="text" class="form-control form-control-solid text-end"
                                                name="price[]" placeholder="0.00" data-kt-element="price" disabled />
                                        </td>
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea name="notes" class="form-control form-control-solid" rows="3"
                                        placeholder="Thanks for your business">{{$purchaseorders->comments}}</textarea>
                                </div>
                                <!--end::Notes-->
                ...
                <div class="card" data-kt-sticky="true" data-kt-sticky-name="invoice"
                    ...
                    <div class="card-body p-10">
                        ...
                        <div class="mb-10">
                            ...
                            <select id="vendor_pay_method" name="pay_method" data-control="select2"
                                data-placeholder="Select Payment Method" class="form-select form-select-solid"
                                data-hide-search="true">


                                @foreach (\App\Models\Bank::all() as $vendor_payment)
                                <option value="{{ $vendor_payment->name }}" @if($purchaseorders->bank_name ==
                                    $vendor_payment->name) selected @endif>{{ $vendor_payment->name }}</option>
                                @endforeach
                                {{-- <option></option>
                                @foreach($agents_banks as $agents_bank)
                                    <option value="{{ $agents_bank->id }}">{{ $agents_bank->name}} -
                                {{ $agents_bank->acc_no}}</option>
                                @endforeach --}}
                            </select>
                            <!--end::Select-->
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <label
                                ...
                                <select name="payment_status_id" id="my_bank_payment_status_id"
                                    class="form-select form-select-solid" data-control="select2"
                                    data-placeholder="Select an option" data-hide-search="true">
                                    <option></option>
                                    @foreach (\App\Models\PaymentStatus::all() as $payment_status)
                                    <option value="{{ $payment_status->name }}" @if($purchaseorders->payment_status ==
                                        $payment_status->name) selected @endif>{{ $payment_status->name }}</option>
                                    @endforeach
                                </select>
                            </label>
                            <!--end::Option-->
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <input disabled name="date" class="form-control form-control-solid"
                                    placeholder="Payment Date" id="kt_daterangepicker_3"
                                    value="{{ $purchaseorders->date}}" />
                            </label>
                            <!--end::Option-->
                            <!--begin::Option-->
                            <label
                                ...
                                <!--begin::Select-->
                                <select name="my_pay_method" id="my_own_bank_payment_status_id" data-control="select2"
                                    data-placeholder="Select Payment Method" class="form-select form-select-solid"
                                    data-hide-search="true">
                                    @foreach($own_banks as $own_bank)
                                    <option value="{{ $own_bank->name }}" @if($purchaseorders->bank_name ==
                                        $own_bank->name) selected @endif>{{ $own_bank->name}}</option>
                                    @endforeach
                                </select>
                                <!--end::Select-->
                            </label>
                            ...
                            <label
                                ...
                                <input disabled type="text" class="form-control form-control-solid" name="check_no"
                                    placeholder="cheque Number" id="my_own_bank_chk_id"
                                    value="{{ $purchaseorders->check_no}}" />
                            </label>
                            <!--end::Option-->
                            ...
                            <label
                                ...
                                <select name="order_status_id" disabled id="purchase_order_status_id"
                                    class="form-select form-select-solid" data-control="select2"
                                    data-placeholder="Select an option" data-hide-search="true">
                                    <option></option>
                                    @foreach (\App\Models\OrderStatus::all() as $order_status)
                                    <option value="{{ $order_status->id }}" @if($purchaseorders->order_status_id ==
                                        $order_status->id) selected @endif>{{ $order_status->name }}</option>
                                    @endforeach
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid flex-stack mb-5">
                                ...
                                <input disabled name="receive_date" class="form-control form-control-solid"
                                    placeholder="Receival Date" id="kt_daterangepicker_new"
                                    value="{{ $purchaseorders->receive_date}}" />
                            ...
                            <label
                                ...
                                <select name="PO_transport" id="PO_transport_id" class="form-select form-select-solid"
                                    data-control="select2" data-placeholder="Select an option" data-hide-search="true">
                                    @foreach (\App\Models\PurchaseOrder::all()->where('order_type','purchase') as
                                    $po_status)
                                    <option value="{{ $po_status->id }}" @if($po_numbers->PO_TPO_related_id ==
                                        $po_status->code) selected @endif>{{ $po_status->code  }}</option>
                                    @endforeach
                                </select>
                            </label>
                            <!--end::Option-->
