...
<div style="max-width: 701px;border-bottom: 2px solid #ddd;margin: 40px auto 0;padding-bottom: 20px;"
    ...
    <div>
        <div style="color: #272727;font-size: 18px; font-weight: 400;">
            <p style="color: #000000;font-size: 16px;font-weight: 500; float: right;">{{$order_info[0]->invoice}}</p>
            <img src="{{public_path('frontend/assets/logo/qbits_logo_black.svg')}}" alt="Qbits Logo"
                style="display: block; margin-left: 18%; width: 100px;" />
            <p style=" float: left;">Invoice Date: {{date('d M Y',strtotime($order_info[0]->invoice_date))}}</p>
        </div>
        <div>
...
<div style=" width: 701px; margin: 20px auto;" class="invoice-header">
    <div class=" float: left; ps-3 pt-2 pb-1">
        <p style="color: #272727;font-size: 18px; font-weight: 400;"><b>Customer Name:</b> {{$name}}</p>
