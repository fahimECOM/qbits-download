...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post" style="z-index:1">
        ...
        <div id="kt_content_container" class="container-xxl">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-start min-w-250px">Product Name</th>
                                ...
                                @if(App\Models\User::hasPermission(["view_sales_order","capture_cancel_sales_order"]))
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td data-kt-ecommerce-order-filter="order_id">
                                    <span href="" class="px-0 mx-0 fw-bolder">{{$orders->order_no}}</span>
                                </td>
                                <td></td>
                                <!--end::Order ID=-->
                                <!--begin::Customer=-->
                                ...
                                <td>
                                    ...
                                    {{--  <div class="d-flex align-items-start">
                                        ...
                                        <!-- <div class="symbol  symbol-40px overflow-hidden me-3">
																<a href="">
																	<div class="symbol-label">
																		<img src="{{(!empty($details['productid']['galary_photo']))?url($details['productid']['galary_photo']):url('/avatar.png')}}"
            ...
            <div class="ms-2 d-flex align-items-center py-5" style="">
                <?php } else {?>
                <?php } ?>
                <!--begin::Title-->
        ...
        <div class="ms-2 d-flex align-items-center py-5" style="">
            ...
            <span class="fw-bolder">{{ substr($details['productid']['name'],0,80)}}...</span>
        </div>
        @endforeach
        </td>
        ...
        <td class="text-start pe-0">
            ...
            @endphp
            <span class="fw-bolder">&#2547;{{number_format(($Totalprice - $discountPrice),2, '.', ',')}}</span>
        </td>
        <td class="text-start pe-0" data-order="Completed">
            <!--begin::Badges-->
            <!-- <div class="badge badge-light-success">{{ucfirst($orders->delivery_status)}}</div> -->
