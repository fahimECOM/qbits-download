                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <!--begin::Name=-->
                                <td>
                                    <div class="text-gray-800 text-hover-primary mb-1">{{$customers->name}}</div>
                                </td>
                                <!--end::Name=-->
                                <!--begin::Email=-->
                                <td>
                                    <div class="text-gray-600 text-hover-primary mb-1">{{$customers->email}}</div>
                                </td>
                                <!--end::Email=-->
                                <!--begin::Status=-->
                                <td>
                                    <!--begin::Badges-->
                                    <div class="text-gray-600 text-hover-primary mb-1">{{$customers->phone}}</div>
                                    <!--end::Badges-->
                                </td>
                                <!--end::Status=-->
                                <!--begin::IP Address=-->
                                <td>
                                    <div class="text-gray-600 text-hover-primary mb-1">{{$customers->address}}</div>
                                </td>
                                <!--end::IP Address=-->
                                <!--begin::Date=-->
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{route('admin.customer.view',$customers->id)}}"
                                                class="menu-link px-3">View</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <!-- <a  class="btn btn-sm btn-danger" data-kt-customer-table-filter="delete_row" href="{{route('customer.delete',$customers->id)}}"> Delete</a> -->
                                            <!-- <a href="{{route('customer.delete',$customers->id)}}"  class="menu-link px-3" >Delete</a> -->
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
