                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{(!empty($customer->avatar))?url($customer->avatar):url('/avatar.png')}}"
                                        alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                ...
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="fs-5 fw-bold text-muted mb-6">{{$customer->email}}</div>
                                <!--end::Position-->
                                <!--begin::Info-->
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true"
                                data-bs-toggle="tab" href="#kt_customer_view_overview_statements">Events &amp; Logs</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5"
                                        ...
                                        <tbody class="fs-6 fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#"
                                                        class="text-gray-600 text-hover-primary mb-1">INV{{$sellerid->order_no}}</a>
                                                </td>
                                                <!--end::Invoice=-->
                                                <!--begin::Status=-->
                                                <td>
                                                    <span
                                                        class="badge badge-light-success">{{$sellerid->delivery_status}}</span>
                                                </td>
                                                @php
                                                $amount =
                                                App\Models\OrderDetail::where('order_id',$sellerid->order_no)->sum('price');
                                                ...
                                                <!--end::Amount=-->
                                                <!--begin::Date=-->
                                                <td>{{date('d M Y',strtotime($sellerid->date))}}</td>
                                                <!--end::Date=-->
                                                <!--begin::Action=-->
                                                <td class="pe-0 text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{route('admin.order.details',$sellerid->id)}}"
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate"
                                                ...
                                                <div class="me-3">
                                                    <div class="d-flex align-items-center">
                                                        <div class="text-gray-800 fw-bolder">Cash on Delivery</div>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Phone Number</td>
                                                ...
                                                <div class="flex-equal">
                                                    <table class="table table-flush fw-bold gy-1">
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">{{$customer->address}}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Email</td>
                                                            <td class="text-gray-800">
                                                                <a href="#"
                                                                    class="text-gray-900 text-hover-primary">{{$customer->email}}</a>
                                            ...
                                            <table id="kt_customer_details_invoices_table_1"
                                                ...
                                                <tbody class="fs-6 fw-bold text-gray-600">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="#"
                                                                class="text-gray-600 text-hover-primary">#{{$sellerid->order_no}}</a>
                                                            @php
                                                            $amount =
                                                            App\Models\OrderDetail::where('order_id',$sellerid->order_no)->sum('price');
                                                        ...
                                                        <td>
                                                            <span
                                                                class="badge badge-light-info">{{$sellerid->delivery_status}}</span>
                                                        </td>
                                                        <td>{{date('d M Y',strtotime($sellerid->date))}}</td>
                                                    </tr>
                                                    @endforeach
                                            ...
                                            <table id="kt_customer_view_statement_table_1"
                                                ...
                                                <thead class="border-bottom border-gray-200">
                                                    ...
                                                    <tr
                                                        ...
                                                        <th class="w-100px">Traked ID</th>
                                                        <th class="w-300px">Case Title</th>
                                                        <th class="w-100px">Status</th>
                                                        <th class="w-100px text-end pe-7">Actions</th>
                                                    </tr>
                                                    <!--end::Table row-->
                                                </thead>
                                                <!--end::Table head-->
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{$tickets->Tracking_number}}
                                                        </td>
                                                        <td>{{$tickets->subject}}</td>
                                                        <td class="">
                                                            @if($tickets->status == "Open")
                                                            <div class="badge badge-light-success">{{$tickets->status}}
                                                            </div>
                                                            @elseif($tickets->status == "Processing")
                                                            <div class="badge badge-light-warning ">{{$tickets->status}}
                                                            </div>
                                                            @elseif($tickets->status == "Close")
                                                            <div class="badge badge-light-danger">{{$tickets->status}}
                                                            </div>
                                                            @endif
                                                        </td>
                                                        <td class="text-end">
                                                            <a href="{{ route('admin.support.ticket.userInfo',$tickets->id)}}"
                                ...
                                <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                                    <div class="fs-6 fw-bold mb-2 text-muted">New Balance
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            title="Enter an amount to preview the new balance."></i></div>
