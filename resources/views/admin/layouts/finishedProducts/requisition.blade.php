    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex  fw-bolder fs-3 align-items-center my-1">Finish Product</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-dark">Creation Process</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            <a href="{{route('requisition.creation')}}" type="button"
                                class="btn btn-md btn-primary">Request Requisition</a>
                ...
                <form id="requisitionSubmitFrm">
                    ...
                    <div class="row  my-2">
                        <div class="col-md-4 mb-3">
                            ...
                            <select id="select_product_type" class="form-select form-select-solid coupon_status"
...
<div class="modal fade" id="requisitionCreationBarcodeScannerModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md p-5">
        <div class="modal-content p-5">
            ...
            <input type="hidden" name="rq_creation_skd_brand" id="rq_creation_skd_brand" value="">
...
<script>
    ...
    jQuery('#select_product_type').change(function () {
        ...
        jQuery('#select_bb_model').html('<option value="NULL">Select Model</option>');
    ...
    function openVerifyBarcodeScaningModal(rq_id, rq_qty, rq_size, rq_brand, rq_type) {
        ...
        $('#rq_creation_skd_brand').val(rq_brand);
    ...
    function entryAllSKDSerialNumberForVerify() {
        ...
        var rq_creation_skd_brand = $('#rq_creation_skd_brand').val();
        ...
        if (text) {
            jQuery.ajax({
                ...
                data: 'verify_rq_creation_current_code=' + verify_rq_creation_current_code +
                    ...
                    rq_creation_size + '&rq_creation_skd_brand=' +
                    rq_creation_skd_brand + '&_token=' + jQuery("[name='_token']").val(),
                type: 'post',
                success: function (result) {
    ...
    //This function used real time available skd qty checking against given product qty
    function requisitionQtyCheck(input) {
        if (input.value < 1) input.value = '';
        if (input.value > 1000) input.value = '';
        jQuery.ajax({
            url: '/admin/finished/product/requisition/creation/check',
            data: 'prod_qty=' + 5 + '&_token=' + jQuery("[name='_token']").val(),
            type: 'post',
            success: function (result) {
