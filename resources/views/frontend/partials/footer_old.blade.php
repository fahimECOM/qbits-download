...
<section class="footer-area-section">
        ...
        <div class="row footer-area">
            <div class="col-sm-12 col-lg-2 col-md-3">
                <div class="footer-content">
                    ...
                    <ul style="line-height: 32px;">
                        <li><span style="color:#a1a1a6;"><a href="{{route('contact')}}">Contact Qbits Care</a></span></li>
                        <li><span style="color:#a1a1a6;">793/1, Monipur, Mirpur-2, Dhaka</span></li>
                        <li><span style="color:#a1a1a6;">02-58055541<br>+8801312145675<br>[ 10 AM - 10 PM ]</span></li>
                        <li><span style="color:#a1a1a6;">info@myqbits.com</span></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-lg-4 col-md-4">
                <div class="footer-content">
                    ...
                    <p style="color: #A1A1A6;">Stay connected with us, Qbits keeps you updated about the latest
    ...
    <div class="footer">
        @php
            $year = date("Y");
        @endphp
        <p style="color: #A1A1A6">Copyright © {{$year}} Qbits Technologies. All rights reserved.</p>
    </div>
