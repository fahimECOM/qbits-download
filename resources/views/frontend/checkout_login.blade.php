                                    ...
                                    <div class="login-form">
                                        <div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="usr" name="email" placeholder="input email">
                                            </div>
                                        </div>

                                        <div>
                                            <div class="form-group">
                                                <input type="password" class="form-control" id="usr" name="pwd" placeholder="input Password">
                                            </div>
                                       </div>
                                       <span><a href="" style="color: #000000;">Forget password</a></span><br/>
                                       {{-- <a href="" class="btn login_btn">Log in</a> --}}
                                       <div class="col">
