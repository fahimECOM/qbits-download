...
@section('admin-content')
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							<!--begin::Container-->
							<div id="kt_content_container" class="container-xxl" style="margin-bottom: 50px">
								<!--begin::Hero card-->
								...
								<div class="card">
									<!--begin::Body-->
									<div class="card-body pt-10 pb-2 pt-lg-15 pb-lg-5">
										<!--begin::Classic content-->
										<div class="mb-13">
											<!--begin::Intro-->
											<div class="mb-12 ps-5">
												<!--begin::Title-->
												<h3 class="text-gray-700 w-bolder mb-6">Frequesntly Asked Questions</h3>
												<!--end::Title-->
												<!--begin::Text-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_1">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">How do I check my order status?</h5>
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_1" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">To check your order status, please contact our support center.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_2">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">Can I change the shipping address on my order?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_2" class="collapse hide fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">Qbits does not make any change once the order is placed. Before placing an order make sure you have provided your desired address.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_3">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">What payment methods does Qbits accept?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_3" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">We accept Credit or Debit Card, Visa, Master Card, DBBL Nexus, Cash Transactions</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_4">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">How can I register my laptop?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_4" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">If you purchased a Qbits, go to the product registration page of our website and enter your verified email and serial number of your laptop.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_5">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">How long does Qbits laptop have a warranty?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_5" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">We offer a 2-year limited hardware warranty.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_6">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">How can I check my laptop warranty?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_6" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">To check your laptop warranty go to your website, enter your serial number, and check your warranty status. Or you can contact our support center.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_7">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">Where can I buy Qbits products?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_7" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">Shop either on our physical store or online store.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
											...
											<div class="row ps-5">
												...
												<div class="col-md-12 pe-md-10 mb-10 mb-md-0">
													...
													<div class="m-0">
														<!--begin::Heading-->
														<div class="d-flex justify-content-between align-items-center collapsed py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_4_8">
															<!--begin::Icon-->
															<h5 class="text-gray-700 fw-bolder cursor-pointer mb-0">What is the coverage of the warranty policy?</h5>
															<div class="btn btn-sm btn-icon mw-20px btn-active-color-primary">
																<!--begin::Svg Icon | path: icons/duotune/general/gen036.svg-->
																<span class="svg-icon toggle-on svg-icon-primary svg-icon-1">
																	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
														...
														<!--end::Heading-->
														<!--begin::Body-->
														<div id="kt_job_4_8" class="collapse fs-6">
															<!--begin::Text-->
															<div class="mb-4 text-gray-600 fw-bold fs-6">The authorized service provider provides immediate service for any defect in the parts/components that are the covered by the warranty policy.</div>
															<!--end::Text-->
														</div>
														<!--end::Content-->
														<!--begin::Separator-->
