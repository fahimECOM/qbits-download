                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item menu-accordion ">
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                ...
                                <div class="menu-item ps-5">
                                    <a class="menu-link" href="{{ route('minipc')}}" target="_blank">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Lania</span>
                                    </a>
                                </div>
                        ...
                        <div data-kt-menu-trigger="click"
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div data-kt-menu-trigger="click"
                                    class="menu-item menu-accordion ps-5 mb-1 {{($route=='support.ticket.create') || ($route=='support.ticket.list') || ($route=='support.ticket.edit') ? 'show': '' }}">
                                    <span class="menu-link">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                    ...
                                    <div class="menu-sub menu-sub-accordion">
                                        ...
                                        <!-- <div class="menu-item">
													<a class="menu-link" href="{{route('admin.support.ticket.view')}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
